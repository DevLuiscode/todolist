...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 3318620282834820199),
      name: 'Group',
      lastPropertyId: const IdUid(3, 4177508025947056598),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6153236239205114507),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 7877342278704383230),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 4177508025947056598),
            name: 'color',
            type: 6,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 1798262387770794102),
      name: 'Task',
      lastPropertyId: const IdUid(4, 7378318149799973794),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 4233927286351122957),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5201545127295884984),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 4147213393766372945),
            name: 'state',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 7378318149799973794),
            name: 'groupId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 8408356815979575433),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 1798262387770794102),
      lastIndexId: const IdUid(1, 8408356815979575433),
  ...
  final bindings = <Type, EntityDefinition>{
    Group: EntityDefinition<Group>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = Group(
              id: idParam, description: descriptionParam, color: colorParam);
    ...
    Task: EntityDefinition<Task>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = Task(
              id: idParam, description: descriptionParam, state: stateParam);
...
class Group_ {
  ...
  static final description =
      QueryStringProperty<Group>(_entities[0].properties[1]);
...
class Task_ {
  ...
  /// see [Task.state]
  static final state = QueryBooleanProperty<Task>(_entities[1].properties[2]);
